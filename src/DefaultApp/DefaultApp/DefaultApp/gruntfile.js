...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        msbuild: {
            'release-console': {
                src: ['../DefaultApp.AppConsole/DefaultApp.AppConsole.csproj'],
                options: {
            ...
            'release-winforms': {
                src: ['../DefaultApp.AppWinForms/DefaultApp.AppWinForms.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
            ...
            'release-resources': {
                src: ['..\\DefaultApp.Resources\\DefaultApp.Resources.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
        ...
        nugetrestore: {
            'restore-console': {
                src: '../DefaultApp.AppConsole/packages.config',
                dest: '../../packages/'
            },
            'restore-winforms': {
                src: '../DefaultApp.AppWinForms/packages.config',
                dest: '../../packages/'
            },
            'restore-webapp': {
                src: './packages.config',
            ...
            'restore-resources': {
                src: '../DefaultApp.Resources/packages.config',
                dest: '../../packages/'
            }
        },
        msdeploy: {
